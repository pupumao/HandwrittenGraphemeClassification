...
config.TRAIN.epoch = 180

config.TRAIN.lr_value_every_epoch = [
    0.00001, 0.0001, 0.001, 0.0001, 0.00001, 0.000001, 0.0000001]  # no use
config.TRAIN.lr_decay_every_epoch = [1, 2, 80, 100, 120, 140]

config.TRAIN.weight_decay_factor = 5.e-3  # l2
...
# input size during training , 128,160,   depends on
config.MODEL.hin = 137//2
config.MODEL.win = 236//2
...
config.DATA.root_path = '/data/old_machine/dataset/bengaliai-cv'
