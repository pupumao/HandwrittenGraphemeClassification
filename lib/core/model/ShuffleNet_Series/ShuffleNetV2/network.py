...
from lib.core.model.ShuffleNet_Series.ShuffleNetV2.blocks import ShuffleV2Block
...
class ShuffleNetV2(nn.Module):
    def __init__(self, input_size=224, n_class=1000, model_size='1.5x'):
        ...
        self.first_conv = nn.Sequential(
            nn.Conv2d(cfg.MODEL.channel, input_channel, 3, 2, 1, bias=False),
        ...
        self.conv_1_ = nn.Conv2d(input_channel, 168, (1, 1), 1,bias=True)
        self.conv_2_ = nn.Conv2d(input_channel, 11, (1, 1), 1,bias=True)
        self.conv_3_ = nn.Conv2d(input_channel, 7, (1, 1), 1,bias=True)
